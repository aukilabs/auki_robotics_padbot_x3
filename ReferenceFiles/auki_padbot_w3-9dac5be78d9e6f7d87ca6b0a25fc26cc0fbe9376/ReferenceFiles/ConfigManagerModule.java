...
public class ConfigManagerModule extends ReactContextBaseJavaModule {
    ...
    public void getFloat(String key, float defaultValue, Promise promise) {
        try {
            ...
            mainHandler.post(() -> promise.reject("CONFIG_ERROR", "Failed to get float value: " + e.getMessage()));
        }
    }
    ...
    public void getString(String key, String defaultValue, Promise promise) {
        try {
            ...
            mainHandler.post(() -> promise.reject("CONFIG_ERROR", "Failed to get string value: " + e.getMessage()));
        }
    }
    ...
    public void getInt(String key, int defaultValue, Promise promise) {
        try {
            ...
            mainHandler.post(() -> promise.reject("CONFIG_ERROR", "Failed to get int value: " + e.getMessage()));
        }
    }
    ...
    public void getBoolean(String key, boolean defaultValue, Promise promise) {
        try {
            ...
            mainHandler.post(() -> promise.reject("CONFIG_ERROR", "Failed to get boolean value: " + e.getMessage()));
        }
    }
    ...
    public void getSpeeds(Promise promise) {
        try {
            ...
            mainHandler.post(() -> promise.reject("CONFIG_ERROR", "Failed to get speeds: " + e.getMessage()));
        }
    }
